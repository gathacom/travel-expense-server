...
const { getByTrip, getById, store, update, destroy } = require("../controllers/expenseController");
...
router.put('/expense/:id',isValidTrip, isValidExpense, isAuthor, validate(expenseSchema), update)
